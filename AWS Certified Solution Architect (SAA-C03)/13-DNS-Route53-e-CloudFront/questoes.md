...
Um cenario exige decisao correta em Route 53 e CloudFront. Qual abordagem e mais aderente?

A) Aplicar solucao generica sem considerar latency routing.
B) Usar latency routing com configuracao orientada ao requisito e operacao enxuta.
...
**Explica̤̣o:**
A alternativa B cobre o objetivo tecnico de route 53 e cloudfront com melhor equilibrio entre requisito, risco e operacao.
...
B) Dimensionar com base no uso real e aproveitar weighted quando fizer sentido.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
...
B) A que ignora sinais de CDN e dependencias da arquitetura.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
...
B) Treinar questoes focadas em cache e OAC/OAI com explicacao de trade-offs.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
